...
export const campaignChapters: CampaignChapter[] = [
  { id: 'chapter-1', order: 1, title: 'O Primeiro Codigo', description: 'Logica, variaveis, condicionais e loops.', icon: 'sparkles', visualTheme: '#49E3B3', bossId: 'boss-syntax' },
  ...
  { id: 'chapter-6', order: 6, title: 'Entrevista Final', description: 'Carreira, portfolio e desafios mistos.', icon: 'trophy', visualTheme: '#ffd166', requiredChapterId: 'chapter-5', bossId: 'boss-master' }
];
