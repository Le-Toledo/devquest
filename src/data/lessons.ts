  ...
  },
  {
    ...
    modules: [
      ...
      module('qualidade', 'Qualidade HTML', 'Validacao, SEO, performance e manutencao.', 'avancado', [
        ...
        topic('seo', 'SEO tecnico basico', 'SEO', 'Ajudar buscadores a entenderem paginas.', '<meta property="og:title" content="CodeQuest Academy" />', 'SEO tecnico comeca em titulo, descricao, hierarquia e links claros.', 'Use quando conteudo precisa ser encontrado ou compartilhado.', 'Escrever titulo generico e headings desordenados.', 'Combine semantica, conteudo real e metadata.', 'Tornar pagina compreensivel para busca'),
