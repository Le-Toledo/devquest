...
export const achievementDefinitions: AchievementDefinition[] = [
  ...
  { id: 'shop-first-buy', title: 'Primeiro Resgate', description: 'Resgate seu primeiro item com moedas ganhas no jogo.', icon: '🎁', reward: { xp: 20 }, progress: (profile) => ({ current: profile.stats?.shopPurchases ?? 0, goal: 1 }) },
